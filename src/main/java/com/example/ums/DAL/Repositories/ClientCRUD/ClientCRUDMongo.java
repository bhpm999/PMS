package com.example.ums.DAL.Repositories.ClientCRUD;
...
public class ClientCRUDMongo implements IClient {
    ...
    public void create(Map<String, Object> p) {
        ...
        for (Medicine m : medicines) {
            ...
            if (medicineDoc != null) {
                ...
                Document orderDoc = new Document("user_id", LogINBLL.userID)
    ...
    public ObservableList<Order> readOrder() {
        ObservableList<Order> ordersList = FXCollections.observableArrayList();
            ...
            MongoCursor<Document> cursor = ordersCollection.aggregate(Arrays.asList(
                    ...
                    new Document("$match", new Document("user_id", LogINBLL.userID)),
                    new Document("$project", new Document()
                            .append("id", 1)
